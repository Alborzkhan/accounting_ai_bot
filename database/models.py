...
def init_db(db_path="accounting.db"):
    ...
    business_types = [
        ...
        ('مدیریت آپارتمان‌ها', 'دریافت شارژ و هزینه‌های جاری ساختمان توسط مدیر مجتمع'),
    ]
    ...
    # توجه مهم: کد حساب (Account.code) در کل سیستم یکتای سراسری است (نه فقط در هر نوع کسب‌وکار)،
    # پس کدهای هر نوع کسب‌وکار باید در بازه جدا و بدون تصادم باشند. کدهای 1001/1002/1101/2001/3001/4001
    # «عمومی» هستند و توسط پارسرهای ساده متنی/صوتی/گفتگو (core/text_command_handler.py,
    # ai_handlers/voice_to_accounting.py, core/smart_dialog_engine.py) به‌صورت ثابت ارجاع داده می‌شوند؛
    # تغییر ندهید. حساب‌های اختصاصی هر نوع کسب‌وکار در بازه‌های زیر تعریف شده‌اند تا تصادم نکنند:
    # بازرگانی=51xx، تولیدی=52xx/13xx، خدماتی=53xx، پیمانکاری=54xx، مدیریت آپارتمان=16xx/45xx/55xx.
    default_accounts = {
        'بازرگانی': [
            ('1001', 'صندوق', 'asset'),
            ('1002', 'بانک', 'asset'),
            ('1003', 'تنخواه‌گردان', 'asset'),
            ('1101', 'بدهکاران تجاری', 'asset'),
            ('1201', 'موجودی کالا', 'asset'),
            ('2001', 'بستانکاران تجاری', 'liability'),
            ('3001', 'سرمایه', 'equity'),
            ('4001', 'فروش کالا', 'income'),
            ('5101', 'بهای تمام شده کالای فروش رفته', 'expense'),
            ('5102', 'هزینه حمل بازرگانی', 'expense'),
        ],
        'تولیدی': [
            ('1001', 'صندوق', 'asset'),
            ('1002', 'بانک', 'asset'),
            ('1003', 'تنخواه‌گردان', 'asset'),
            ('1101', 'بدهکاران تجاری', 'asset'),
            ('1301', 'مواد اولیه', 'asset'),
            ('1302', 'کالای در جریان تولید', 'asset'),
            ('1303', 'ماشین‌آلات', 'asset'),
            ('2001', 'بستانکاران تجاری', 'liability'),
            ('3001', 'سرمایه', 'equity'),
            ('4201', 'فروش محصولات', 'income'),
            ('5201', 'بهای تمام شده تولید', 'expense'),
        ],
        'خدماتی': [
            ('1001', 'صندوق', 'asset'),
            ('1002', 'بانک', 'asset'),
            ('1003', 'تنخواه‌گردان', 'asset'),
            ('1102', 'بدهکاران خدمات', 'asset'),
            ('2001', 'بستانکاران', 'liability'),
            ('3001', 'سرمایه', 'equity'),
            ('4301', 'درآمد خدمات', 'income'),
            ('5301', 'هزینه حقوق پرسنل خدماتی', 'expense'),
        ],
        'پیمانکاری': [
            ('1001', 'صندوق', 'asset'),
            ('1002', 'بانک', 'asset'),
            ('1003', 'تنخواه‌گردان', 'asset'),
            ('1103', 'بدهکاران پروژه', 'asset'),
            ('1304', 'پروژه‌های در دست اجرا', 'asset'),
            ('2002', 'بستانکاران پیمانکاری', 'liability'),
            ('3001', 'سرمایه', 'equity'),
            ('4401', 'درآمد پیمانکاری', 'income'),
            ('5401', 'هزینه مستقیم پیمان', 'expense'),
        ],
        'مدیریت آپارتمان‌ها': [
            ('1001', 'صندوق', 'asset'),
            ('1002', 'بانک', 'asset'),
            ('1003', 'تنخواه‌گردان', 'asset'),
            ('1601', 'بدهکاران شارژ واحدها', 'asset'),
            ('3001', 'سرمایه', 'equity'),
            ('4501', 'درآمد شارژ دریافتی', 'income'),
            ('5501', 'هزینه برق مشاعات', 'expense'),
            ('5502', 'هزینه آب مشاعات', 'expense'),
            ('5503', 'هزینه گاز مشاعات', 'expense'),
            ('5504', 'هزینه نظافت ساختمان', 'expense'),
            ('5505', 'هزینه آسانسور', 'expense'),
            ('5506', 'هزینه موتورخانه', 'expense'),
            ('5507', 'سایر هزینه‌های جاری ساختمان', 'expense'),
        ],
    }
    ...
    # حساب‌های مشترک بین همه انواع کسب‌وکار (مثلاً اجاره، حقوق، آب و برق) - مستقل از نوع کسب‌وکار
    common_accounts = [
        ('5601', 'هزینه حقوق و دستمزد', 'expense'),
        ('5602', 'هزینه اجاره', 'expense'),
        ('5603', 'هزینه حمل و نقل', 'expense'),
        ('5604', 'هزینه تعمیر و نگهداری', 'expense'),
        ('5605', 'هزینه کارمزد بانکی', 'expense'),
        ('5606', 'هزینه بیمه', 'expense'),
        ('5607', 'هزینه تبلیغات', 'expense'),
        ('5608', 'هزینه مالیاتی', 'expense'),
        ('5609', 'هزینه آب و برق و سوخت', 'expense'),
        ('5610', 'هزینه تلفن و اینترنت', 'expense'),
        ('4601', 'سایر درآمدها', 'income'),
        ('3900', 'سود (زیان) انباشته', 'equity'),
    ]
    for code, name, acc_type in common_accounts:
        if not session.query(Account).filter_by(code=code).first():
            session.add(Account(code=code, name=name, type=acc_type))
